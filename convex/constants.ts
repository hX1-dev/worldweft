...
// 太虚界对话纪律（World Foundation · W4a）：关闭 AI Town 原生「闲置即找人闲聊」。
// 对话改由修仙需求驱动（convex/xianxia/routineLogic.ts：回报委托 / 叙旧…），不再是默认行为。
// 改回 false 即恢复原生社交模拟行为。
export const SUPPRESS_IDLE_CONVERSATION = true;

// 太虚界在场纪律（World Foundation · W4b）：关闭 AI Town 原生「空闲随机闲逛」。
// 修士移动改由修仙层 travel / 委托 / 日程驱动，避免身体被随机目的地拖出语义 zone。
// 改回 false 即恢复原生随机游走。
export const SUPPRESS_IDLE_WANDER = true;
...
// 太虚界地图活动气泡（M7）：角色在地图上「做某事」时随机展示，换成修仙活动。
export const ACTIVITIES = [
  { description: '打坐吐纳', emoji: '🧘', duration: 60_000 },
  { description: '参悟功法', emoji: '📜', duration: 60_000 },
  { description: '炼制丹药', emoji: '⚗️', duration: 60_000 },
  { description: '擦拭法剑', emoji: '🗡️', duration: 60_000 },
  { description: '感应灵气', emoji: '✨', duration: 60_000 },
];
