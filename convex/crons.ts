...
// 太虚界自动推进（M7）：每 90s 让修士们自主行动一回合。
// autoTick 内部检查 XIANXIA_AUTO_TICK 开关，默认关闭（不调 DeepSeek、零成本）。
crons.interval('xianxia agent tick', { seconds: 90 }, internal.xianxia.agent.autoTick);
